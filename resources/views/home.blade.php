                    ...
                    <div class="card-group d-block d-md-flex row">
                        <div class="card col-md-7 p-4 mb-0">
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <ul class="list-arrow">
                                        <li><a href="login.php">login page for users</a></li>
                                        <li><a href="firstpage.php">Accreditation Data</a></li>
                                        <li><a href="res1.php">result Test</a></li>
                                        <li><a href="res2.php">DashBoard</a></li>
                                        <li><a href="graph.php">VIEW </a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
